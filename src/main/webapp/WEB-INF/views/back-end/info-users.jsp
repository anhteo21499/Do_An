        ...
        <table id="table-sanpham" class="table">
            ...
            <c:forEach var="user" items="${users}">
                <tr>
                    ...
                    <td>${user.roles }</td>
                    <td><a
                            href="${pageContext.request.contextPath}/admin/update/user/${user.id}"
                            class="btn btn-primary btn-sm">Sửa</a> &nbsp; <a
                            href="${pageContext.request.contextPath}/admin/info-users/delete/${user.id}"
                            class="btn btn-primary btn-sm" >Xoá</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
