...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div class="row"
			...
			<h2>Sản phẩm</h2>
			<div class="export-product" style="text-align: center; display: flex; justify-content:flex-start">
				<div class="export-product-ep">
					<a href="${pageContext.request.contextPath}/products/export/excel">
						Export Exels
					</a>
				</div>
				<div class="export-product-ep">
					<a href="${pageContext.request.contextPath}/products/export/pdf">
						Export PDF
					</a>
				</div>
			</div>
