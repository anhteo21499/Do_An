...
<div class="box">
	<div class="boxa" >
		<img class="card-img-top"
									src="${pageContext.request.contextPath}/file/upload/${product.productImage.get(0).path }" id="imagemain">
	</div>
	<div class="boxb" style="display: flex;width: 330px;height: 70px;margin-top: 20px;">
		<ul>
			<li>
				<img class="card-img-top"
...
<div class="boxn" style="width: 485px;height: 84px;background-color: #f0f0f0;margin-top: 20px;font-size: 18px;">
	...
	<p style="color: blue;">
		Từ ngày 01/06 đến 30/06/2021, Tặng bộ quà cao cấp gồm:<br>
        - Tai nghe thời trang <br>
        - Chuột không dây cao cấp.<br>
        - Bộ vệ sinh <br>
        - Balo Phúc Anh thời trang.<br>
        - Tặng gói bao hành trực tiếp tại cửa hàng
	</p>
</div>
<!-- box -->
...
<%--	</p>--%>
<%--</div>--%>
     <div class="box-left-2" style="margin-top:0px;height: 152px;">
...
<div class="danh-muc-main" style="width:450px;height: 500px;margin-left: 430px;margin-top: 50px; ">
	<img class="slide" src="${pageContext.request.contextPath}/file/upload/${product.productImage.get(1).path }" idx ="0" style="width:450px;height: 350px;">
	<img class="slide" src="${pageContext.request.contextPath}/file/upload/${product.productImage.get(2).path }" idx ="1" style="width:450px;height: 350px;">
	<img class="slide" src="${pageContext.request.contextPath}/file/upload/${product.productImage.get(3).path }" idx ="2" style="width:450px;height: 350px;">
	<img class="slide" src="${pageContext.request.contextPath}/file/upload/${product.productImage.get(4).path }" idx ="3" style="width:450px;height: 350px;">
...
<div style="width: 100%">${product.shortDetails }</div>

			<div class="col-lg-9">
				<div class="row"
					style=" width: 1200px;position: relative;display: flex;justify-content: space-evenly;">
		        <h4 class="sptt" style="position: absolute;margin-bottom: 50px;"> SẢN PHẨM TƯƠNG TỰ</h4>
					<c:forEach var="product" items="${products }">
						<div class="colum-n" style="margin-top: 20px; margin-right:10px">
